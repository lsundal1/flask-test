...
from services.Service import get_all_books_service, get_book_by_id_service, create_book_service
...
def create_book_route():
    ...
    new_book_id = create_book_service(title, price_in_pence, quantity_in_stock, release_date, is_fiction)
    return jsonify({'message': 'book created successfully', 'book_id': new_book_id})
